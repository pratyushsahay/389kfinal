...
var Team = function (_Record) {
  _inherits(Team, _Record);
  ...
  _createClass(Team, [{
    ...
    key: 'getFormattedTeamAbbreviation',
    value: function getFormattedTeamAbbreviation() {
      return this.abbreviation + ' ' + _nbaEmoji2.default.getEmoji(this.abbreviation);
    }
  }]);
