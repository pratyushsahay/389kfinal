...
var defaults = {
  scope: '',
  name: '',
  medium: _BroadcastMedium2.default.TV
};

var Broadcast = function (_Record) {
  _inherits(Broadcast, _Record);

  function Broadcast(scope, name, medium) {
    ...
    return _possibleConstructorReturn(this, (Broadcast.__proto__ || Object.getPrototypeOf(Broadcast)).call(this, {
      scope: scope,
      name: name,
      medium: medium
    }));
