...
var StartedGameTableCreator = function () {
  ...
  _createClass(StartedGameTableCreator, null, [{
    key: 'create',
    value: function create(data) {
      ...
      StartedGameTableCreator.generateRows(data).forEach(function (row) {
    ...
    value: function generateRows(data) {
      var linescoresRows = StartedGameTableCreator.generateLinescoresRows(data);
      var metadataRows = StartedGameTableCreator.generateMetadataRows(data);
    ...
    value: function generateMetadataRows(data) {
      ...
      rows = rows.push(StartedGameTableCreator.generateMetadataRow(_nodeEmoji2.default.get(_Constants2.default.START_TIME_EMOJI_VALUE), data.getLocalizedStartDateTime(), rowNumbers));
      return rows.push(StartedGameTableCreator.generateMetadataRow(_nodeEmoji2.default.get(_Constants2.default.BROADCASTS_EMOJI_VALUE), data.getTvBroadcastsString(), rowNumbers));
    }
  }, {
